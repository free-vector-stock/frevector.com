...
const MODAL_CONTENTS = {
    about: { 
        ...
        <p>All files can be used in both personal and commercial projects. <strong>Our only rule is this:</strong> Files cannot be redistributed, sold, or reshared as part of a package.</p>` 
    },
    privacy: { 
        ...
        <p>We do not sell user data to third parties. Cookies may be used to enhance site functions.</p>` 
    },
    terms: { 
    ...
    contact: { 
        ...
        <p>For copyright or support questions, please reach out via email.</p>` 
    }
};
